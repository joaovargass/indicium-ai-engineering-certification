...
from common.config import DEFAULT_DAYS, DEFAULT_MONTHS, NO_DATA_MESSAGE_CHARTS
...
def get_daily_chart_json(
    ...
    days: Annotated[int, f"Days to display (default: {DEFAULT_DAYS})."] = DEFAULT_DAYS,
    title: Annotated[
        str | None,
        "Chart title in user's language (e.g., 'Daily Cases' or 'Casos Diários').",
    ] = None,
    x_axis_label: Annotated[
        str | None, "X-axis label in user's language (e.g., 'Date' or 'Data')."
    ] = None,
    y_axis_label: Annotated[
        str | None,
        "Y-axis label in user's language (e.g., 'Number of Cases' or 'Número de Casos').",
    ] = None,
) -> str:
    ...
    try:
        ...
        return json.dumps({"error": NO_DATA_MESSAGE_CHARTS})
...
def get_monthly_chart_json(
    ...
    city_code: Annotated[str | None, "IBGE city code. Overrides UF."] = None,
    months: Annotated[
        int, f"Months to display (default: {DEFAULT_MONTHS})."
    ] = DEFAULT_MONTHS,
    title: Annotated[
        str | None,
        "Chart title in user's language (e.g., 'Monthly Cases' or 'Casos Mensais').",
    ] = None,
    x_axis_label: Annotated[
        str | None, "X-axis label in user's language (e.g., 'Month' or 'Mês')."
    ] = None,
    y_axis_label: Annotated[
        str | None,
        "Y-axis label in user's language (e.g., 'Number of Cases' or 'Número de Casos').",
